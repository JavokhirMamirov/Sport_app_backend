...
(function($, window, document, undefined) {
	...
	$.fn.imageuploadify = function(opts) {
		...
		this.each(function() {
			...
			let totalFiles = [];
			let counter = 0;
			let dragbox = $(`<div class="imageuploadify well"><div class="imageuploadify-overlay"><i class="fa fa-picture-o"></i></div><div class="imageuploadify-images-list text-center"><i class="bx bxs-cloud-upload"></i><span class='imageuploadify-message'>Sport obyekti rasmlarini yuklash</span><button type="button"class="btn btn-default">Rasmni tanlash</button></div></div>`);
			...
			$(self).closest("form").on("submit", function(event) {
				...
				for (let index = 0; index < inputs.length; ++index) {
					...
					} else if ((inputs[index].getAttribute("type").toLowerCase()) === "checkbox" && inputs[index].checked ) {
						formData.append(inputs[index].name, inputs[index].value);
					}
				}
